...
for ((i=0; i<24; i++))
do
    echo "Running the program Hour : $((i+1))"
    $EXECUTABLE_PATH
    ...
    if [ "$sendAlert" = true ]; then
        ...
        curl --ssl-reqd --url 'smtps://smtp.gmail.com:465' --user 'huzaifadaniyal5@gmail.com:donf plqi jegl anca' --mail-from 'huzaifadaniyal5@gmail.com' --mail-rcpt 'hamzanaveed3210@gmail.com' --upload-file mail.txt
    fi
done
